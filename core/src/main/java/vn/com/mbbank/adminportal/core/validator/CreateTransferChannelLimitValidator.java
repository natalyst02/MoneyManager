...
@Component
public class CreateTransferChannelLimitValidator implements Validator<CreateTransferChannelLimitRequest> {
    @Override
    public void validate(CreateTransferChannelLimitRequest createRequest, List<FieldViolation> fieldViolations) {
